      ...
      <div class="hero-body">
        <div class="container">
          <div class="th-logo has-text-centered">
            <img src="https://cdn.treehouseinternetgroup.com/cms_images/3351/sunshine-foundation_repair_logo.svg" alt="" style="width:250px">
          </div>
 ...
 <!----------------- Modal ---------------->    
        ...
        <modal name="output" :height="500">
          ...
          <div class="gif-box level-item has-text-centered">
            <ul>
              <li>1. Place cursor at the top-left corner of Sunshine Foundation Repair logo and click & drag to bottom-right corner of the disclaimer</li>
    ...
    <footer class="" id="footer">
        <div class="container">
            <div class="content has-text-centered">
                <p>
                    &copy;2022 Sunshine Foundation Repair
                </p>
            </div>
        </div>
    </footer>
