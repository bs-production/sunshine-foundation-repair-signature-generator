      ...
      <section>
        ...
        <tr>
            <td valign="top" style="padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 7px; border-top: 0; border-bottom: 0: border-left: 0;">
              <a href="https://www.sunshinefoundationrepair.com/" target="_blank">
                <img v-show="mobilePhoneSwitch" width="220" height="139" style="width: 220px; max-width: 220px !important; height: 139px; max-height: 139px !important; margin-top: 5px;" id="preview-image-url" src="https://cdn.treehouseinternetgroup.com/cms_images/3351/sunshine-fr-signature-logo-bar.png" name="preview-image-url" />
        
                <img v-show="!mobilePhoneSwitch" width="190" height="121" style="width: 190px; max-width: 190px !important; height: 121px; max-height: 121px !important; margin-top: 5px;" id="preview-image-url" src="https://cdn.treehouseinternetgroup.com/cms_images/3351/sunshine-fr-signature-logo-bar.png" name="preview-image-url" />
              </a>
            </td>
            ...
            "background: none; border-width: 0px; border: 0px; margin: 0; padding: 0;">
              <tr>
                  <td colspan="2" style=
                  "padding-bottom: 5px; color: #1F4397; font-size: 18px; font-family: Arial, Helvetica, sans-serif;">
                  {{fullName}}
                  </td>
                </tr>
                <tr>
              ...
              <div v-show="!mobilePhoneSwitch">
                ...
                <tr>
                  ...
                  "vertical-align: top; width: 20px; color: #1F4397; font-size: 14px; font-family: Arial, Helvetica, sans-serif;">
                  Direct:
                  </td>
                  <td valign="top" style=
                ...
                <tr>
                  ...
                  <td valign="top" style=
                  "vertical-align: top; color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif;">
                  <a href="https://www.sunshinefoundationrepair.com/" target="_blank" style=
                  "color: #333333; text-decoration: none; font-weight: normal; font-size: 14px;">
                    sunshinefoundationrepair.com</a>
                    &nbsp;&nbsp;
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="2" style="padding-top: 5px;">
                    <a href="https://www.facebook.com/SunshineFoundationRepair" target="_blank" style=
...
<!-- 
        ...
        <!-- <p><a href="https://www.sunshinefoundationrepair.com/refer-give-to-get.html" style="font-weight:bold; color:#000;">We <i>LOVE Referrals</i><img width="20" height="20" style="border: none; width: 20px; max-width: 20px !important; height: 20px; max-height: 20px !important;" src="https://cdn.treehouseinternetgroup.com/cms_images/48/cursor-click.png" /></a></p> -->
